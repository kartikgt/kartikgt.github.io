...
\bluebullet Java &  \bluebullet C++\\
\bluebullet Python &  \bluebullet Apache\\
\end{tabular}

\Sep
\textbf{Skills}\\
\bluebullet Vue.JS | Java | SQL | Scala | Linux | Shell scripting \\
\bluebullet Apache Hadoop | Hive | HDFS | Ambari | Apache Spark \\
